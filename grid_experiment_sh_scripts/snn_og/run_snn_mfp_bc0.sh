...
#SBATCH -J 20240613_mfp_snn_bc_experiment      #job name
...
#SBATCH --output=scratch/anticancer-synergy-prediction-scratch/experiments/20240613_snn/mfp_snn_bc_%a_slurm.out           #output file
#SBATCH --error=scratch/anticancer-synergy-prediction-scratch/experiments/20240613_snn/mfp_snn_bc_%a_slurm.err            #error file

source env/bin/activate

SCRATCH="scratch/anticancer-synergy-prediction-scratch/"

PYOF=$SCRATCH"experiments/20240613_snn/mfp_snn_bc"$SLURM_ARRAY_TASK_ID".txt"
PLOT=$SCRATCH"experiments/20240613_snn/mfp_snn_bc"
...
python3 run_snn_models.py --output_fp $PLOT --use_mfp --use_bc > $PYOF
