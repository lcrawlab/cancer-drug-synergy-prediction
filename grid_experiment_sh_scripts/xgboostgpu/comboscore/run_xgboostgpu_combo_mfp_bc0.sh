...
#SBATCH -J 20250712_combo_mfp_xgboostgpu_bc_experiment      #job name
...
PYOF=$SCRATCH"experiments/20250712_combo_xgboostgpu/mfp_xgboostgpu_bc"$SLURM_ARRAY_TASK_ID".txt"
PLOT=$SCRATCH"experiments/20250712_combo_xgboostgpu/mfp_xgboostgpu_bc"
...
python3 models/run/run_xgboostgpu_models.py --score 'COMBOSCORE' --use_mfp --use_bc --output_fp $PLOT"metrics.csv" > $PYOF
