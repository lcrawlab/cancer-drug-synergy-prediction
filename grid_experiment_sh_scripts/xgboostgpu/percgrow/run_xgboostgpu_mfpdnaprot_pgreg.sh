...
#SBATCH -J 20250712_pg_mfpdnaprot_xgboostgpu_pgreg_experiment      #job name
...
#SBATCH --output=scratch/anticancer-synergy-prediction-scratch/experiments/20250712_pg_xgboostgpu/mfpdnaprot_xgboostgpu_pgreg_%a_slurm.out           #output file
#SBATCH --error=scratch/anticancer-synergy-prediction-scratch/experiments/20250712_pg_xgboostgpu/mfpdnaprot_xgboostgpu_pgreg_%a_slurm.err            #error file

source env/bin/activate

SCRATCH="scratch/anticancer-synergy-prediction-scratch/"
export PYTHONPATH="${PYTHONPATH}:~/cancer-drug-synergy-prediction/"
PYOF=$SCRATCH"experiments/20250712_pg_xgboostgpu/mfpdnaprot_xgboostgpu_pgreg"$SLURM_ARRAY_TASK_ID".txt"
PLOT=$SCRATCH"experiments/20250712_pg_xgboostgpu/mfpdnaprot_xgboostgpu_pgreg"
