...
#SBATCH -J 20250629_zip_mfprnaprot_rf_csreg_experiment      #job name
...
#SBATCH --output=scratch/anticancer-synergy-prediction-scratch/experiments/20250629_zip_rf/mfprnaprot_rf_csreg_%a_slurm.out           #output file
...
python3 models/run/run_rf_models.py --score 'ZIP' --use_mfp --use_rna --use_prot --use_csreg --output_fp $PLOT"metrics.csv" > $PYOF
