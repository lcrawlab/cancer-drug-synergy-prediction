...
#SBATCH -J 20240604_mfp_rf_csreg_experiment      #job name
...
#SBATCH --output=scratch/anticancer-synergy-prediction-scratch/experiments/20240604_randomforest/mfp_rf_csreg_%a_slurm.out           #output file
#SBATCH --error=scratch/anticancer-synergy-prediction-scratch/experiments/20240604_randomforest/mfp_rf_csreg_%a_slurm.err            #error file

source env/bin/activate

SCRATCH="scratch/anticancer-synergy-prediction-scratch/"

PYOF=$SCRATCH"experiments/20240604_randomforest/mfp_rf_csreg"$SLURM_ARRAY_TASK_ID".txt"
PLOT=$SCRATCH"experiments/20240604_randomforest/mfp_rf_csreg"
...
python3 run_randomforest_models.py --use_mfp --use_csreg --output_fp $PLOT > $PYOF
