...
#SBATCH -J 20251002_combo_mfpdnarnaprot_pcnngl_csreg_experiment      #job name
...
#SBATCH --output=scratch/anticancer-synergy-prediction-scratch/experiments/20251002_combo_pcnngl/mfpdnarnaprot_pcnngl_csreg_%a_slurm.out           #output file
#SBATCH --error=scratch/anticancer-synergy-prediction-scratch/experiments/20251002_combo_pcnngl/mfpdnarnaprot_pcnngl_csreg_%a_slurm.err            #error file
...
PLOT=$SCRATCH"experiments/20251002_combo_pcnngl/mfpdnarnaprot_pcnngl_csreg"
...
python3 models/src/modelPCNNGL.py --score 'COMBOSCORE' --use_mfp --use_dna --use_rna --use_prot --use_csreg --output_fp $PLOT"metrics.csv" > $PYOF
