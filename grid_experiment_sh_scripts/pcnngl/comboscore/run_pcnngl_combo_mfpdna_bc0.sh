...
#SBATCH -J 20251002_combo_mfpdna_pcnngl_bc_experiment      #job name
...
#SBATCH --output=scratch/anticancer-synergy-prediction-scratch/experiments/20251002_combo_pcnngl/mfpdna_pcnngl_bc_%a_slurm.out           #output file
#SBATCH --error=scratch/anticancer-synergy-prediction-scratch/experiments/20251002_combo_pcnngl/mfpdna_pcnngl_bc_%a_slurm.err            #error file
