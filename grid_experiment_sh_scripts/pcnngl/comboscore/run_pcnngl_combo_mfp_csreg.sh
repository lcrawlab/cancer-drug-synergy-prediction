...
PLOT=$SCRATCH"experiments/20251002_combo_pcnngl/mfp_pcnngl_csreg"
...
python3 models/src/modelPCNNGL.py --score 'COMBOSCORE' --use_mfp --use_csreg --output_fp $PLOT"metrics.csv" > $PYOF
